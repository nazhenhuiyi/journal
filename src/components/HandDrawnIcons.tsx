...
export function Undo(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path d="M9.2 7.1c-1.45 1.02-2.8 2.18-4.04 3.5 1.28 1.18 2.62 2.22 4.04 3.12" />
      <path d="M5.22 10.62c3.2-.24 6.12-.08 8.28.48 2.9.76 4.52 2.42 4.32 4.38-.18 1.75-1.9 3.08-4.58 3.34" />
      <path d="M7.15 9.32c2.3-.1 4.4.05 6.15.42" opacity="0.42" />
    </IconFrame>
  )
}

export function Redo(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path d="M14.8 7.1c1.45 1.02 2.8 2.18 4.04 3.5-1.28 1.18-2.62 2.22-4.04 3.12" />
      <path d="M18.78 10.62c-3.2-.24-6.12-.08-8.28.48-2.9.76-4.52 2.42-4.32 4.38.18 1.75 1.9 3.08 4.58 3.34" />
      <path d="M16.85 9.32c-2.3-.1-4.4.05-6.15.42" opacity="0.42" />
    </IconFrame>
  )
}

export function Play(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path
        d="M8.1 5.48c3.58 1.78 6.65 3.82 9.52 6.28-2.78 2.58-5.82 4.78-9.42 6.62-.32-4.1-.34-8.58-.1-12.9Z"
        fill="currentColor"
        fillOpacity="0.16"
      />
      <path d="M8.1 5.48c3.58 1.78 6.65 3.82 9.52 6.28-2.78 2.58-5.82 4.78-9.42 6.62-.32-4.1-.34-8.58-.1-12.9Z" />
    </IconFrame>
  )
}

export function Pause(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path d="M7.35 5.4c1.12-.14 2.04-.12 3.12.04.18 4.1.16 8.65-.06 13.15-1 .12-2.02.1-3.04-.04-.22-4.18-.24-8.82-.02-13.15Z" />
      <path d="M13.58 5.45c1.08-.16 2.1-.14 3.15.02.24 4.2.22 8.78-.02 13.02-.96.18-2.02.18-3.08.02-.22-4.16-.24-8.72-.05-13.06Z" />
    </IconFrame>
  )
}

export function Eraser(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path
        d="M5.35 14.45c2.52-3.38 5.25-6.35 8.4-9.18.7-.62 1.52-.58 2.16.06l2.55 2.55c.66.66.64 1.46-.02 2.14-2.45 2.5-4.95 4.98-7.5 7.42-1.65.18-3.32.14-5.02-.1-.58-.72-.78-1.72-.57-2.9Z"
        fill="currentColor"
        fillOpacity="0.12"
      />
      <path d="M5.35 14.45c2.52-3.38 5.25-6.35 8.4-9.18.7-.62 1.52-.58 2.16.06l2.55 2.55c.66.66.64 1.46-.02 2.14-2.45 2.5-4.95 4.98-7.5 7.42-1.65.18-3.32.14-5.02-.1-.58-.72-.78-1.72-.57-2.9Z" />
      <path d="M11.2 7.72c1.92 1.32 3.42 2.82 4.82 4.72" opacity="0.52" />
      <path d="M4.72 19.25c3.75.34 7.62.34 11.55-.02" opacity="0.5" />
    </IconFrame>
  )
}

export function Trash(props: HandDrawnIconProps) {
  return (
    <IconFrame {...props}>
      <path d="M6.18 7.82c3.6-.34 7.58-.34 11.6.02" />
      <path d="M9.28 7.22c.18-.95.42-1.72.74-2.32 1.42-.18 2.75-.16 4.02.04.32.68.56 1.42.72 2.28" />
      <path d="M7.75 9.38c.22 3.12.62 6.42 1.12 9.68 2.1.42 4.25.42 6.42.02.5-3.1.85-6.42 1.04-9.72" />
      <path d="M10.6 11.72c.04 1.78.12 3.3.28 4.7" opacity="0.5" />
      <path d="M13.52 11.7c-.04 1.72-.13 3.3-.28 4.72" opacity="0.5" />
    </IconFrame>
  )
}
